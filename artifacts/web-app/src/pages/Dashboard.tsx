            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {vehicles.map((v) => {
                ...
                return (
                  <button
                    key={v.id}
                    onClick={() => { onSwitchVehicle(v); setShowVehiclePicker(false); }}
                    style={{
                      width: "100%",
                      background: isActive ? C.greenLight : C.sage,
                  ...
                  >
                    ...
                    {isActive && (
                      <span style={{ width: 10, height: 10, borderRadius: "50%", background: C.green, flexShrink: 0, display: "block" }} />
                    )}
                  </button>
                );
              })}
